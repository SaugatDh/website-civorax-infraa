...
export const siteConfig = {
  ...
  shortName: "CivoraX",
  description:
    "House design, construction, renovation and interior company in Nepal — floor plans, 3D design, cost estimates and turnkey building in Itahari, Dharan and Kathmandu.",
